...
htmlhelp_basename = 'charles-utildoc'
...
latex_documents = [
    (master_doc, 'charles-util.tex', 'charles-util Documentation',
...
man_pages = [
    (master_doc, 'charles-util', 'charles-util Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'charles-util', 'charles-util Documentation',
     author, 'charles-util', 'One line description of project.',
     'Miscellaneous'),
]
